...
doc_events = {
	...
	"Purchase Invoice": {
        ...
        "Project": {
                "before_save" : "erpnext.letien_code.replace_proj_code"
        }
}
...
scheduler_events = {
        ...
        "yearly": [
                "erpnext.letien_code.update_years_of_service"
        ],
        "monthly":[
                "erpnext.letien_code.update_month_of_service"
        ]
}
...
get_amounts_not_reflected_in_system_for_bank_reconciliation_statement = "erpnext.accounts.report.bank_reconciliation_statement.bank_reconciliation_statement.get_amounts_not_reflected_in_system>"
